...
Basically, the acfs lie in the confidence interval. However, since the AIC of all the models here are quite large, it seems that they all do not fit very well.

Here we select AMRA(2,2) to do the simulation and compare it with our original data:
...
Compared with original data, the variance of simulation becomes smaller.
