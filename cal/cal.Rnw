...
#    "Class 13. Chapter 9 continued."),
  ...
  c(format.Date(class_date[23]+4,format="%a %b %d"),
    "Homework 8 (group questions on POMP inference, needs chapter 15), Participation 8, due 11:59pm"),    
  ...
  c(format.Date(class_date[25]+1,format="%a %b %d"),    
    "Homework 9 (canceled to work on the final project?), Participation 9, due 11:59pm"),    
