...
canceled <- c(2,14,15) # MLK and spring break
...
entries <- rbind(
  ...
  c(format.Date(class_date[2]+4,format="%a %b %d"),
    "Homework 1 (needs first half of chapter 2), Participation 1, due 11:59pm"),    
  ...
  c(format.Date(class_date[4],format="%a %b %d"),
    "Class 4. Chapter 4. ARMA models"),
  c(format.Date(class_date[5],format="%a %b %d"),
    "Class 5. Chapter 4 continued"),
  c(format.Date(class_date[6]-1,format="%a %b %d"),
    "Homework 2 (needs chapters 3 and 4). Participation 2, due 11:59pm"), 
  ...
  c(format.Date(class_date[7],format="%a %b %d"),
    "Class 7. Chapter 5 continued"),
  c(format.Date(class_date[8],format="%a %b %d"),
    "Class 8. Chapter 6. Seasonality and trend"),
  ...
  c(format.Date(class_date[12],format="%a %b %d"),
    "Class 12. Chapter 9. Health economics example"),
...
#    "Class 13. Chapter 9 continued."),
  ...
  c(format.Date(class_date[14]+4,format="%a %b %d"),
  ...
  c(format.Date(class_date[19],format="%a %b %d"),
    "Class 19. Chapter 14: iterated filtering"),
  c(format.Date(class_date[20],format="%a %b %d"),
    "Class 20. Chapter 14 continued"),
  c(format.Date(class_date[20]+4,format="%a %b %d"),
    "Homework 7 (particle filter, needs chapter 13), Participation 7, due 11:59pm"),    
  c(format.Date(class_date[21],format="%a %b %d"),
    "Class 21. Chapter 15: polio"),
  c(format.Date(class_date[22],format="%a %b %d"),
    "Class 22. Chapter 15 continued"),
  c(format.Date(class_date[23]+4,format="%a %b %d"),
    "Homework 8 (iterated filtering, needs chapter 14), Participation 8, due 11:59pm"),    
  ...
  c(format.Date(class_date[24],format="%a %b %d"),
    "Class 24. Chapter 16 continued"),
  c(format.Date(class_date[25],format="%a %b %d"),
    "Class 25. Chapter 17. Measles modeling and inference"),
  c(format.Date(class_date[25]+1,format="%a %b %d"),    
    "Homework 9 (group questions on POMP inference), Participation 9, due 11:59pm"),    
  c(format.Date(class_date[26],format="%a %b %d"),
    "Class 26. Chapter 17 continued"),
  c(format.Date(class_date[27],format="%a %b %d"),
   ...
   c(format.Date(class_date[27]+8,format="%a %b %d"),
...
DATASCI/STATS 531 schedule, Winter \Sexpr{format.Date(class1,format='%Y')} \\
\end{center}
